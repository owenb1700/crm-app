...
import { withoutTrashed } from "./trash";
...
async function loadAll() {
  ...
  return {
    customers: withoutTrashed(customersSnap.docs.map(d => ({ id: d.id, ...d.data() }))),
    pipeline: withoutTrashed(pipelineSnap.docs.map(d => ({ id: d.id, ...d.data() }))),
