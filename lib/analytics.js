...
// Who can open the Estimating Analytics page. It's a normal permission
// like any other: on by default for Estimating, off by default for
// everyone else, and an admin can turn it on or off for any one person
// (see lib/permissions.js). Admins always have it.

export const canViewAnalytics = (profile) =>
  !!profile && !profile.disabled &&
  effectivePermissions(profile.role, profile.permissions).analytics === true;
