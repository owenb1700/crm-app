...
export async function saveFirmTags(firmName, category, tags) {
  ...
  // buildings they have. The firm's own category decides, since that's
  // what firmTagsOf reads back -- a form calling someone a contractor
  // doesn't change what the Directory has them as.
  const field = (firm.category || category) === "Contractor" ? "workTypes" : "sectors";
